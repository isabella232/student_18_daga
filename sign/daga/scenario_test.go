...
//
//func setup(nc, ns int) ([]kyber.Point, []kyber.Point, []kyber.Point, []kyber.Point, error){
//	//Generates clients
//	var X []kyber.Point
...
//		if err != nil {
//			return nil, nil, nil, nil, errors.New(fmt.Sprintf("Cannot create clients:\n%s\n", err))
//		}
...
//		if err != nil {
//			return nil, nil, nil, nil, errors.New(fmt.Sprintf("Cannot create servers:\n%s\n", err))
//		}
...
//		if err != nil {
//			return nil, nil, nil, nil, errors.New(fmt.Sprintf("Error in client's geenrators:\n%s\n", err))
//		}
//		H = append(H, temp)
//	}
//
...
//
//	//Client's protocol
//	// FIXME port test to new kyber proof implementation but before check that "proofs are the same"
//
